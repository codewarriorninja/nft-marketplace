...
const MarketPlaceNftCards = ({imgUrl, text, profilePicture, profileName, Price,HighstBid}) => {
  return (
    <div>
        <div className="flex flex-col justify-center">
            ...
            />
            <div className="py-5 bg-neutral-800 rounded-br-[20px] rounded-bl-[20px]">
...
export default MarketPlaceNftCards